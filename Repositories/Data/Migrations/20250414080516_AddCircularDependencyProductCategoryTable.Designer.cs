...
namespace Repositories.Data.Migrations
{
    ...
    [Migration("20250414080516_AddCircularDependencyProductCategoryTable")]
    partial class AddCircularDependencyProductCategoryTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusinessObjects.Shop.ProductCategory", b =>
                {
                    ...
                    b.HasOne("BusinessObjects.Shop.ProductCategory", "OfCategory")
                        .WithMany("Categories")
                        .HasForeignKey("OfCategoryId");

                    b.Navigation("CreatedBy");

                    b.Navigation("ModifiedBy");

                    b.Navigation("OfCategory");
                });
